...
export class AccordionManager {
    ...
    openSectionByName(sectionName) {
        const sectionsChanged =
            this.sectionStrategy.openSectionByName(sectionName);
    ...
    _handleSectionSelect(sectionId) {
        const sectionChanged =
            this.sectionStrategy.handleSectionSelect(sectionId);
    ...
    _deregisterSection(deletedSectionId) {
        const sectionsChanged =
            this.sectionStrategy.handleSectionWillDeregister(deletedSectionId);
